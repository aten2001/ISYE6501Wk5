...
The estimated MSE as a function of log(lambda) from both LASSO and elastic net is shown in Figure \@ref(fig:glmnetcompare). The minimum MSE achieved by LASSO is `r min(model.lasso$cvm)` while that of the elastic net is `r min(model.elastic$cvm)`. 
